...
{
    public class ServicioSherwin : Servicio, IProduccion
    {
        ...
        private bool esWebUserExcluyente(int WebUserID)
        {
            ...
            bool esUsuarioxcluyente = clienteDAO.esUsuarioExcluyente(WebUserID);
            //Lista de Webuser que paso Mario Escobedo  + Lo que se agrego 
            ...
            return _webUsersID.Any(x => x == WebUserID) || esUsuarioxcluyente;            
        }
